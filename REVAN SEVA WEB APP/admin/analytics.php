...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >RaVen <b style="color: #11a3ad; ">SeVa</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $q6="SELECT count(*) as count FROM food_donations where location=\"tirunelveli\"";
            $res6=mysqli_query($connection, $q6);
            $ro6=mysqli_fetch_assoc($res6);
            $tirunelveli=$ro6['count'];
            $q7="SELECT count(*) as count FROM food_donations where location=\"thoothukkudi\"";
            $res7=mysqli_query($connection, $q7);
            $ro7=mysqli_fetch_assoc($res7);
            $thoothukkudi=$ro7['count'];
            

    ?>
var xValues = ["Male","Female"];
var xplace=["Madurai","chennai","coimbatore","tirunelveli","thoothukkudi"];
var yplace=[<?php echo json_encode($madurai,JSON_HEX_TAG);?>,<?php echo json_encode($coimbatore,JSON_HEX_TAG);?>,<?php echo json_encode($chennai,JSON_HEX_TAG);?>,<?php echo json_encode($tirunelveli,JSON_HEX_TAG);?>,<?php echo json_encode($thoothukkudi,JSON_HEX_TAG);?>];
var yValues = [<?php echo json_encode($male,JSON_HEX_TAG);?>,<?php echo json_encode($female,JSON_HEX_TAG);?>,30];
var barColors = ["#06C167","blue"];
var bar=["#06C167","blue","red","pink","skyblue"]
